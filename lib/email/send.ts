...
export async function sendConnectionAcceptedEmails(params: ConnectionAcceptedParams) {
  ...
  const founderHtml = `
    <div style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto;background:#F9F7F2;padding:40px 32px;border-radius:12px;color:#18160F">
      <p style="font-size:11px;text-transform:uppercase;letter-spacing:0.15em;color:#8A867C;margin:0 0 24px">Edge Alpha</p>
      ...
      <a href="${APP_URL}/founder/messages"
      ...
      <p style="font-size:12px;color:#8A867C;margin:40px 0 0">You're receiving this because you have an Edge Alpha account.</p>
    </div>
  `
  ...
  const investorHtml = `
    <div style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto;background:#F9F7F2;padding:40px 32px;border-radius:12px;color:#18160F">
      ...
      <p style="font-size:15px;line-height:1.6;color:#18160F;margin:0 0 32px">
        We've notified the founder. You can now message them directly from your Edge Alpha dashboard.
      </p>
      <a href="${APP_URL}/investor/messages"
         style="display:inline-block;background:#18160F;color:#F9F7F2;text-decoration:none;padding:12px 24px;border-radius:8px;font-size:14px;font-weight:500">
        Open Messages →
      </a>
      <p style="font-size:12px;color:#8A867C;margin:40px 0 0">You're receiving this because you have an Edge Alpha investor account.</p>
    </div>
  `
