      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "40px 28px 80px" }}>
        ...
        >
          ...
          {artifacts.length > 0 ? (
            ...
            <div style={{ background: surf, borderRadius: 12, padding: "20px 24px", border: `1px solid ${bdr}`, textAlign: "center" }}>
              ...
              <Link href="/founder/cxo" style={{ fontSize: 12, color: blue, textDecoration: "none", fontWeight: 600, display: "inline-flex", alignItems: "center", gap: 4, marginTop: 8 }}>
        ...
        <div style={{ borderTop: `1px solid ${bdr}`, paddingTop: 20, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div className="no-print">
            <Link href="/founder/cxo" style={{ fontSize: 11, color: blue, textDecoration: "none", fontWeight: 500, display: "flex", alignItems: "center", gap: 4 }}>
