            ...
            <div style="font-family:system-ui,-apple-system,sans-serif;max-width:580px;margin:0 auto;color:#18160F">
              ...
              <div style="padding:28px">
                ...
                <div style="margin-top:20px;text-align:center">
                  <a href="${APP_URL}/founder/executive" style="display:inline-block;padding:11px 24px;background:#18160F;color:#fff;border-radius:8px;text-decoration:none;font-size:13px;font-weight:600">Review with your executive team →</a>
                </div>
              </div>
            ...
            html: `
              <div style="font-family:system-ui,-apple-system,sans-serif;max-width:580px;margin:0 auto;color:#18160F">
                ...
                <div style="padding:28px">
                  ...
                  <div style="margin-top:20px;text-align:center">
                    <a href="${APP_URL}/founder/executive" style="display:inline-block;padding:11px 24px;background:#DC2626;color:#fff;border-radius:8px;text-decoration:none;font-size:13px;font-weight:600">See what your team is doing →</a>
                  </div>
            ...
            html: `
              <div style="font-family:system-ui,-apple-system,sans-serif;max-width:580px;margin:0 auto;color:#18160F">
                ...
                <div style="padding:28px">
                  ...
                  <div style="margin-top:20px;text-align:center">
                    <a href="${APP_URL}/founder/executive" style="display:inline-block;padding:11px 24px;background:#EA580C;color:#fff;border-radius:8px;text-decoration:none;font-size:13px;font-weight:600">See what your team is doing →</a>
                  </div>
                  <p style="margin-top:16px;font-size:11px;color:#8A867C;text-align:center">
          ...
          html: `
            <div style="font-family:system-ui,-apple-system,sans-serif;max-width:580px;margin:0 auto;color:#18160F">
              ...
              <div style="padding:28px">
                ...
                <div style="margin-top:20px;text-align:center">
                  <a href="${APP_URL}/founder/executive" style="display:inline-block;padding:11px 24px;background:#15803D;color:#fff;border-radius:8px;text-decoration:none;font-size:13px;font-weight:600">See what your team is doing →</a>
                </div>
                <p style="margin-top:16px;font-size:11px;color:#8A867C;text-align:center">
